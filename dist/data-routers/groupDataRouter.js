...
export const groupDataRouter = (block, blockRenderer) => {
    ...
    if (gradient) {
        customClasses = {
            "root-to-dim-split-50-b": "bg-gradient-to-b from-root from-50% via-root-muted via-50% to-root-dim to-50%",
            "dim-to-root-split-50-b": "bg-gradient-to-b from-root-dim from-50% via-root-muted via-50% to-root to-50%",
            "dark-to-root-split-45-r": "bg-gradient-to-r from-root-invert from-45% to-root to-45%",
            "darkest-to-root-split-45-r": "bg-gradient-to-r from-root-invert-dim from-45% to-root to-45%",
            // legacy gradient names below (kept here to ensure styling on old sites doesn't break):
            "root-to-root-dim": "bg-gradient-to-b from-root from-50% via-root-muted via-50% to-root-dim to-50%",
